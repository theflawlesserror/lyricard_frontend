...
return (
    <div className="relative min-h-screen w-full max-w-[100vw] bg-black flex flex-col items-center py-8 sm:py-10 px-4 sm:px-6 font-sans selection:bg-white/20 overflow-x-hidden">
      ...
      <div className="relative z-10 w-full max-w-sm flex flex-col gap-3 mb-10">
        <div className="flex flex-col gap-2.5">
          <Input 
            ...
            className="bg-zinc-900/60 backdrop-blur-2xl border-white/5 text-zinc-100 placeholder:text-zinc-100/50 h-12 rounded-xl w-full"
          />
          <Input 
      ...
      <div className="mt-auto pt-8 z-10 text-center">
        <p className="text-zinc-500 text-xs sm:text-sm font-medium tracking-widest">
